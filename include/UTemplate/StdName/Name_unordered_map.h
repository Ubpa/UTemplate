...
template<typename Key, typename T>
struct Ubpa::details::custom_type_name<std::pmr::unordered_map<Key, T>> {
	static constexpr auto get() noexcept {
		return concat_seq(
...
template<typename Key, typename T, typename Hash, typename KeyEqual>
struct Ubpa::details::custom_type_name<std::pmr::unordered_map<Key, T, Hash, KeyEqual>> {
	static constexpr auto get() noexcept {
		return concat_seq(
			TSTR("std::pmr::unordered_map<{"),
			type_name<Key>(),
...
template<typename Key, typename T, typename Hash>
struct Ubpa::details::custom_type_name<std::pmr::unordered_multimap<Key, T, Hash>> {
	static constexpr auto get() noexcept {
		return concat_seq(
			TSTR("std::pmr::unordered_multimap<{"),
			type_name<Key>(),
...
template<typename Key, typename T, typename Hash, typename KeyEqual>
struct Ubpa::details::custom_type_name<std::pmr::unordered_multimap<Key, T, Hash, KeyEqual>> {
	static constexpr auto get() noexcept {
		return concat_seq(
			TSTR("std::pmr::unordered_multimap<{"),
			type_name<Key>(),
