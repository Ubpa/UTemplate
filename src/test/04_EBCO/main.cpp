...
int main() {
	...
	IStruct2<detail::SI::SI_Nil> ECBOs2;
	cout << &ECBOs2 << endl;
	cout << static_cast<IStruct2<detail::SI::SI_Nil>::IStruct1*>(&ECBOs2) << endl;
	cout << static_cast<IStruct2<detail::SI::SI_Nil>::IEmpty1*>(&ECBOs2) << endl;
}
